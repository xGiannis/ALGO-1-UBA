import unittest
from template import elementos_exclusivos, ultima_aparicion, contar_traducciones_iguales, convertir_a_diccionario
...
class Ej1Test(unittest.TestCase):
    ...
    def test_ejemplo2(self):
        res = ultima_aparicion([-1,4,0,4,100,0,100,0,-1,-1],100)
